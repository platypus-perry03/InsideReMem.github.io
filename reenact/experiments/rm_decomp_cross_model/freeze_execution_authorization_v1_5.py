#!/usr/bin/env python3
"""Create the one-time hash-locked execution authorization for R-directed v1.5."""
...
DESIGN_PATH = HERE / "design_v1_5_r_directed_frozen.json"
IMPLEMENTATION_PATH = HERE / "run_cross_model_r_directed_v1_5.py"
STATIC_REVIEW_PATH = HERE / "STATIC_REVIEW_V1_5_R_DIRECTED.md"
OUTPUT_PATH = HERE / "execution_authorization_v1_5_r_directed_frozen.json"
...
def main() -> None:
    ...
    payload = {
        "authorization_id": "cross_model_r_directed_homologue_v1_5_20260901_01",
        ...
        "allowed": [
            "Discovery-only R-directed gap-supporting component screening",
        ...
        "forbidden": [
            ...
            "nonpositive reasoning-mean or nonpositive-Delta candidates mislabeled as R-directed",
