#!/usr/bin/env python3
"""Create the one-time authorization for Meta-Llama M-directed v1.4."""
...
DESIGN_PATH = HERE / "design_v1_4_meta_llama_m_directed_frozen.json"
IMPLEMENTATION_PATH = HERE / "run_meta_llama_m_directed_v1_4.py"
STATIC_REVIEW_PATH = HERE / "STATIC_REVIEW_V1_4_META_LLAMA_M_DIRECTED.md"
OUTPUT_PATH = HERE / "execution_authorization_v1_4_meta_llama_m_directed_frozen.json"
...
def main() -> None:
    ...
    payload = {
        "authorization_id": "meta_llama_m_directed_homologue_v1_4_20260831_01",
        ...
        "allowed": [
            "Discovery-only M-directed gap-supporting component screening",
        ...
        "forbidden": [
            ...
            "negative-Delta candidates mislabeled as M-directed",
