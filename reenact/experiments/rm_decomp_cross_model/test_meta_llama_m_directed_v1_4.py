"""Model-free tests for the frozen Meta-Llama M-directed runner."""
...
import run_meta_llama_m_directed_v1_4 as runner  # noqa: E402
...
class MetaLlamaMDirectedRunnerTests(unittest.TestCase):
    ...
    def test_frozen_design_prohibits_pdf_update(self) -> None:
        design = runner.load_design(HERE / "design_v1_4_meta_llama_m_directed_frozen.json")
