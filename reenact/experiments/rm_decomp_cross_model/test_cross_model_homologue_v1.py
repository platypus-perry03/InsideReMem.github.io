"""Model-free tests for the frozen cross-model homologue runner."""
...
import run_cross_model_homologue_v1 as runner  # noqa: E402
...
class CrossModelRunnerTests(unittest.TestCase):
    ...
    def test_frozen_design_prohibits_pdf_update(self) -> None:
        design = runner.load_design(HERE / "design_v1_1_frozen.json")
