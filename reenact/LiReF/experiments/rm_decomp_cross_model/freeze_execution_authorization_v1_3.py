#!/usr/bin/env python3
"""Create the one-time hash-locked execution authorization for M-directed v1.3."""
...
DESIGN_PATH = HERE / "design_v1_3_m_directed_frozen.json"
IMPLEMENTATION_PATH = HERE / "run_cross_model_m_directed_v1_3.py"
STATIC_REVIEW_PATH = HERE / "STATIC_REVIEW_V1_3_M_DIRECTED.md"
OUTPUT_PATH = HERE / "execution_authorization_v1_3_m_directed_frozen.json"
...
def main() -> None:
    ...
    payload = {
        "authorization_id": "cross_model_m_directed_homologue_v1_3_20260831_01",
