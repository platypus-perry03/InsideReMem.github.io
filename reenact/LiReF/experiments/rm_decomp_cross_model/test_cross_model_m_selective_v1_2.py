"""Model-free tests for the frozen M-selective cross-model runner."""
...
import run_cross_model_m_selective_v1_2 as runner  # noqa: E402
...
class MSelectiveCrossModelRunnerTests(unittest.TestCase):
    ...
    def test_frozen_design_prohibits_pdf_update(self) -> None:
        design = runner.load_design(HERE / "design_v1_2_m_selective_frozen.json")
