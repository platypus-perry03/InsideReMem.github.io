...
RUNNER="AI/reenact/experiments/rm_decomp_cross_model/run_cross_model_m_selective_v1_2.py"
DESIGN="AI/reenact/experiments/rm_decomp_cross_model/design_v1_2_m_selective_frozen.json"
AUTH="AI/reenact/experiments/rm_decomp_cross_model/execution_authorization_v1_2_m_selective_frozen.json"
OUTPUT="AI/reenact/liref_outputs/rm_decomp/cross_model_m_selective_v1_2"
SOCKET="${WORKSPACE}/.tmux-rm-m-v1-2.sock"
SESSION="rm_m_v1_2"
