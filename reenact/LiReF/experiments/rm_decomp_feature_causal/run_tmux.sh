...
SESSION="liref_d_${PHASE}"
ROOT="/home/jinhyun/prj_ws/jiho"
PYTHON="/home/jinhyun/.conda/envs/torch/bin/python"
SCRIPT="$ROOT/AI/reenact/experiments/rm_decomp_feature_causal/run_feature_causal.py"
RUN_ID="$("$PYTHON" -c "import json; print(json.load(open('$ROOT/AI/reenact/experiments/rm_decomp_feature_causal/config.json'))['run_id'])")"
